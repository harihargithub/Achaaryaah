...
var questions = [
  new Question(
    'The oldest Purana?',
    ['Matsya', 'Kurma', 'Markandeya', 'Bhagavata'],
    'Matsya',
  ),
  new Question(
    'The present age is under which Manu?',
    ['Caksusa', 'Vaivasvata', 'Savarni', 'Indra-savarni'],
    'Vaivasvata',
  ),
  new Question(
  ...
  new Question(
    'As a last option to protect himself Asvatthama used?',
    ['Sarpastra', 'Brahmastra', 'Drowning himself', 'Surrender'],
    'Brahmastra',
  ),
  new Question(
    'Who came running when Krishna was about to leave for Dwaraka?',
    ['Kunti', 'Draupadi', 'Gandhari', 'Uttara'],
    'Uttara',
  ),
  new Question(
    'The instructions of Vidura were especially meant for?',
    ['The Pandavas', 'King Dhratarastra', 'Karna', 'Queen Kunti'],
    'King Dhratarastra',
  ),
  new Question(
    'Place Rama visited for sita’s swayamvar?',
    ['Mithila', 'Ayodhya', 'Lanka', 'Panchavati'],
    'Mithila',
  ),
];
